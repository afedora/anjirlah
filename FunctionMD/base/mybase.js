 ...
 var templates = await generateWAMessageFromContent(id, {
  ...
  if(times < "23:59:00"){
    m.sayingtime         = 'Tidur Gan'
    m.timoji = '🌃'}
  if(times < "19:00:00"){
    m.sayingtime         = 'Malam gini enaknya makan gorengam'
    m.timoji = '🌆'}
  if(times < "18:00:00"){
    m.sayingtime         = 'Sore gan'
    m.timoji = '🌇'}
  if(times < "15:00:00"){
    m.sayingtime         = 'Mandi dek dah sore'
    m.timoji = '🌞'}
  if(times < "11:00:00"){
    m.sayingtime         = 'Selamat siang'
    m.timoji = '🌅'}
  if(times < "05:00:00"){
    m.sayingtime         = 'Selamat pagi semoga selalu bahagia'
    m.timoji = '🌃' }  
